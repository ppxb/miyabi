...
func (_c *SettingCreate) SetValue(v jsontext.Value) *SettingCreate {
...
// SetValue sets the "value" field.
func (u *SettingUpsert) SetValue(v jsontext.Value) *SettingUpsert {
...
// SetValue sets the "value" field.
func (u *SettingUpsertOne) SetValue(v jsontext.Value) *SettingUpsertOne {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
...
// SetValue sets the "value" field.
func (u *SettingUpsertBulk) SetValue(v jsontext.Value) *SettingUpsertBulk {
	return u.Update(func(s *SettingUpsert) {
		s.SetValue(v)
	})
}
