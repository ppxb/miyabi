...
func (_u *SettingUpdate) SetValue(v jsontext.Value) *SettingUpdate {
	_u.mutation.SetValue(v)
	return _u
}

// AppendValue appends value to the "value" field.
func (_u *SettingUpdate) AppendValue(v jsontext.Value) *SettingUpdate {
...
// SetValue sets the "value" field.
func (_u *SettingUpdateOne) SetValue(v jsontext.Value) *SettingUpdateOne {
	_u.mutation.SetValue(v)
	return _u
}

// AppendValue appends value to the "value" field.
func (_u *SettingUpdateOne) AppendValue(v jsontext.Value) *SettingUpdateOne {
	_u.mutation.AppendValue(v)
	return _u
}
