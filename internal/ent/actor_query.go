...
func (_q *ActorQuery) QueryMovies() *MovieQuery {
...
func (_q *ActorQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ActorQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ActorQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ActorQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ActorQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ActorQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActorQuery) Clone() *ActorQuery {
	...
	return &ActorQuery{
		...
		withMovies: _q.withMovies.Clone(),
...
func (_q *ActorQuery) WithMovies(opts ...func(*MovieQuery)) *ActorQuery {
	query := (&MovieClient{config: _q.config}).Query()
...
func (_q *ActorQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Actor, error) {
	...
	if query := _q.withMovies; query != nil {
		if err := _q.loadMovies(ctx, query, nodes,
			func(n *Actor) { n.Edges.Movies = []*Movie{} },
			func(n *Actor, e *Movie) { n.Edges.Movies = append(n.Edges.Movies, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ActorQuery) loadMovies(ctx context.Context, query *MovieQuery, nodes []*Actor, init func(*Actor), assign func(*Actor, *Movie)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(actor.MoviesTable)
		s.Join(joinT).On(s.C(movie.FieldID), joinT.C(actor.MoviesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(actor.MoviesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(actor.MoviesPrimaryKey[1]))
