...
func (_q *FileQuery) QueryMovie() *MovieQuery {
...
func (_q *FileQuery) WithMovie(opts ...func(*MovieQuery)) *FileQuery {
	query := (&MovieClient{config: _q.config}).Query()
...
func (_q *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if query := _q.withMovie; query != nil {
		if err := _q.loadMovie(ctx, query, nodes, nil,
			func(n *File, e *Movie) { n.Edges.Movie = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *FileQuery) loadMovie(ctx context.Context, query *MovieQuery, nodes []*File, init func(*File), assign func(*File, *Movie)) error {
